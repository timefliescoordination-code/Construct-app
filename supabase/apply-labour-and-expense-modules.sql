-- =============================================================================
-- ONE-STEP SETUP: Labour teams + expense categories
-- Copy this ENTIRE file into Supabase → SQL Editor → Run
-- Requires: schema.sql already applied (projects, expenses, profiles, set_updated_at)
-- =============================================================================

-- === From labour-teams-module.sql ===
...
create index if not exists expenses_labour_team_id_idx
  on public.expenses (labour_team_id) where labour_team_id is not null;
...
-- === From expense-categories-module.sql ===
